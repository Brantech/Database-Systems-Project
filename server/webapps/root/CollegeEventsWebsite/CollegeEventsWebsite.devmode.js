...
var __gwtModuleFunction = $wnd.CollegeEventsWebsite;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.CollegeEventsWebsite=");
    idx += (13 + "CollegeEventsWebsite".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=CollegeEventsWebsite-0.js
